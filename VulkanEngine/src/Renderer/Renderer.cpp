...
namespace CHIKU
{
	...
	void Renderer::PrivateBeginFrame()
	{
		ZoneScoped;
	...
	void Renderer::BeginRecordingCommands(const VkCommandBuffer& commandBuffer)
	{
		ZoneScoped;
	...
	void Renderer::EndRecordingCommands(const VkCommandBuffer& commandBuffer)
	{
		ZoneScoped;
